                ...
                <div className="container mx-auto px-3 sm:px-4">
                    ...
                    <div className="lg:hidden flex items-center justify-between h-14 gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            <Link to="/templates" className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all">
                            ...
                            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg border-2 border-teal-500 bg-teal-50/30 dark:bg-teal-900/20">
                                <img src="/icon-512.png" alt="FR" className="w-6 h-6" />
                                <span className="text-sm font-bold text-slate-900 dark:text-white">FreeMium Resume</span>
                            </div>
                        </div>
                    ...
                    <div className="hidden lg:flex h-14 items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <Link to="/templates" className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all" title="Back to Templates">
                                <ArrowLeft className="w-4 h-4" />
                            </Link>
                            <Link to="/" className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all" title="Home">
